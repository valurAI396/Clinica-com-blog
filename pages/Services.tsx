    ...
    <div className="pt-32 min-h-screen bg-clarity-bg pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 fade-in-up">
          <span className="text-clarity-primary font-medium tracking-widest uppercase text-sm mb-4 block">Especialidades Clínicas</span>
          <h1 className="font-serif text-4xl md:text-6xl text-clarity-text mb-6">Os Nossos Serviços</h1>
          <p className="text-stone-600 text-lg leading-relaxed">
            Cada percurso terapêutico é único. Dispomos de diversas abordagens para responder às suas necessidades com rigor e humanidade.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="text-xs font-bold text-stone-400 uppercase tracking-wider mb-3">Recomendado para</h4>
                  ...
                  <div className="pt-4 border-t border-stone-100">
                    ...
                    >
                      Agendar esta terapia <ArrowRight size={18} className="ml-2 group-hover:translate-x-1 transition-transform" />
                    </Link>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-20 text-center">
          <div className="bg-clarity-primary text-white rounded-[2rem] p-10 md:p-16 max-w-4xl mx-auto relative overflow-hidden">
             <div className="relative z-10">
               <h3 className="font-serif text-3xl mb-4">Tem dúvidas sobre qual a melhor terapia?</h3>
